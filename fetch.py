#!/usr/bin/env python3
"""
Recupero codici sconto FarmaSave da shopilo.it
Sursa: https://shopilo.it/negozi/farmasave.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/farmasave.it"
STORE_NAME = "FarmaSave"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per FarmaSave da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-farmasave)"
    }
    try:
